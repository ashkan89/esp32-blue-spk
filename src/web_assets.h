...
.rowitem{display:flex;align-items:center;gap:12px;padding:11px 13px;border-radius:14px;background:var(--panel2);border:1px solid var(--line);min-width:0}
...
.rowitem>input[type=checkbox]{flex:0 0 auto;margin:0}

.rowlist.prose .rowitem small{white-space:normal;line-height:1.4;margin-top:2px}

.rowlist.prose .rowitem b{white-space:normal}
...
<div id="radioPanels" class="grid two"><div class="stack"><article class="card panel" id="dlnaCard" style="display:none"><h3>Play from a phone or NAS (UPnP / DLNA)</h3><p class="muted" style="margin-top:-4px">This speaker can appear on the network as a media renderer, so an app like BubbleUPnP, Hi-Fi Cast or VLC can send it a track. Works in <b>Wi-Fi only</b> and <b>DFPlayer + Wi-Fi</b> modes.</p><label class="row" style="gap:10px;align-items:center"><input type="checkbox" id="dlnaEnabled"> <span>Discoverable on this network</span></label><div class="callout" style="margin-top:10px"><b>UPnP has no password.</b> That is the protocol, not this speaker. While this is on, anything on your network can make it play something and change its volume. It cannot reach your settings, your Wi-Fi password or the firmware. Leave it off on a network you do not trust.</div><div id="dlnaState" class="dfnow" style="margin-top:12px"></div></article>
...
<div class="field"><label>What may speak</label><div class="rowlist prose" id="voiceCats"></div></div>
...
<section class="page" id="page-graphs"><div class="sectionhead"><div><h2>Graphs</h2><p>Two hours of history, sampled every thirty seconds.</p></div><button class="btn" id="graphRefresh" data-icon="refresh">Refresh</button></div>
